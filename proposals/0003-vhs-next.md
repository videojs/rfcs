...
| DASH Period Connectivity                                    | ❌             | SHOULD   | `@schemeIdUri` set to `urn:mpeg:dash:period-connectivity:2015`                                                                                                                                                                   | see dash-if timing model                                                    |
| DASH Period Continuity                                      | ❌             | SHOULD   | `@schemeIdUri` set to `urn:mpeg:dash:period-continuity:2015`                                                                                                                                                                     | see dash-if timing model                                                    |
